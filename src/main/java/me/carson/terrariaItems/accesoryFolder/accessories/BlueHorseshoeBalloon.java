...
public class BlueHorseshoeBalloon extends Accessory implements Listener {

    public BlueHorseshoeBalloon(Plugin plugin){
        super(plugin,"blue_horseshoe_balloon.name","#FF9696", Material.NETHER_BRICK,"blue_horseshoe_balloon","BlueHorseshoeBalloon","blue_horseshoe_balloon.lore");
    }
    ...
    public static ItemStack getItem(Plugin plugin) {
        return new BlueHorseshoeBalloon(plugin).createItem();
    }
