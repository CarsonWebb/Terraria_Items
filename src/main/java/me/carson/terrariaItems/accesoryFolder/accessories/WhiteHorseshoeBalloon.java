...
public class WhiteHorseshoeBalloon extends Accessory implements Listener {

    public WhiteHorseshoeBalloon(Plugin plugin){
        super(plugin,"white_horseshoe_balloon.name","#FF9696", Material.NETHER_BRICK,"white_horseshoe_balloon","WhiteHorseshoeBalloon","white_horseshoe_balloon.lore");
    }
    ...
    public static ItemStack getItem(Plugin plugin) {
        return new WhiteHorseshoeBalloon(plugin).createItem();
    }
