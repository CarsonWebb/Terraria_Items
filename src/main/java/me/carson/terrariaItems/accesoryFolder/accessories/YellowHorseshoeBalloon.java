...
public class YellowHorseshoeBalloon extends Accessory implements Listener {

    public YellowHorseshoeBalloon(Plugin plugin){
        super(plugin,"yellow_horseshoe_balloon.name","#FF9696", Material.NETHER_BRICK,"yellow_horseshoe_balloon","YellowHorseshoeBalloon","yellow_horseshoe_balloon.lore");
    }
    ...
    public static ItemStack getItem(Plugin plugin) {
        return new YellowHorseshoeBalloon(plugin).createItem();
    }
