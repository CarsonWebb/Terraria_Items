...
public class BundleOfHorseshoeBalloons extends Accessory implements Listener {

    public BundleOfHorseshoeBalloons(Plugin plugin){
        super(plugin,"bundle_of_horseshoe_balloons.name","#FFFF0A", Material.NETHER_BRICK,"bundle_of_horseshoe_balloons","BundleOfHorseshoeBalloons","bundle_of_horseshoe_balloons.lore");
    }
    ...
    public static ItemStack getItem(Plugin plugin) {
        return new BundleOfHorseshoeBalloons(plugin).createItem();
    }
