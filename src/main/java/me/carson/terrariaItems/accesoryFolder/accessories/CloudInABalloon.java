...
public class CloudInABalloon extends Accessory implements Listener {

    public CloudInABalloon(Plugin plugin){
        super(plugin,"cloud_in_a_balloon.name","#FF9696", Material.NETHER_BRICK,"cloud_in_a_balloon","CloudInABalloon","cloud_in_a_balloon.lore");
    }
    ...
    public static ItemStack getItem(Plugin plugin) {
        return new CloudInABalloon(plugin).createItem();
    }
