...
public class Ebonkoi extends Material {

    public Ebonkoi(Plugin plugin) {
        super(plugin,"ebonkoi.name","#9696FF", org.bukkit.Material.COOKED_COD,"ebonkoi","Ebonkoi","ebonkoi.lore");
    }

    public static ItemStack getItem(Plugin plugin) {
        ItemStack itemstack=new Ebonkoi(plugin).createItem();
