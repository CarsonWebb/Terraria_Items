...
public class BlazingStarProjectile extends RougeProjectiles {

    public BlazingStarProjectile(Plugin plugin) {
        super(plugin, 0,  "blazing_star", "BlazingStarProjectile",5,5, DamageType.TRIDENT,null);
    }
