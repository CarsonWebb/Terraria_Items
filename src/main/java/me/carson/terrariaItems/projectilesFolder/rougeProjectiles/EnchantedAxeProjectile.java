...
public class EnchantedAxeProjectile extends RougeProjectiles {

    public EnchantedAxeProjectile(Plugin plugin) {
        super(plugin, 0,  "enchanted_axe", "EnchantedAxeProjectile",99,0, DamageType.TRIDENT,null);
    }
