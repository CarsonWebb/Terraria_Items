            ...
            switch (args[0].toLowerCase()) {
                case "give" -> {
                    ...
                    switch (itemName) {
                        ...
                        case "daybloom_staff" -> {
                            player.getInventory().addItem(DaybloomStaff.getItem(plugin));
                        }
                        case "sapphire_staff" -> {
                            player.getInventory().addItem(SapphireStaff.getItem(plugin));
                        }
