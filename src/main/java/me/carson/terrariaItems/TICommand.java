        ...
        switch (args[0].toLowerCase()) {
            ...
            case "toggle_prehardmode" -> {
                if (sender.isOp()) {
                    ...
                    sender.sendMessage("Pre-Hardmode Enabled: " + worldDataHandler.getPreHardmodeRecipes());
                    worldDataHandler.save();
                } else {
                    sender.sendMessage(ChatColor.RED + "You do not have permission to use this command");
                }
            ...
            case "toggle_hardmode" -> {
                if (sender.isOp()) {
                    ...
                    sender.sendMessage("Hardmode Enabled: " + worldDataHandler.getHardmodeRecipes());
                    worldDataHandler.save();
                } else {
                    sender.sendMessage(ChatColor.RED + "You do not have permission to use this command");
                }
